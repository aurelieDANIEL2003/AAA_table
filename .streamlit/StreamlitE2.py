...
from utils11 import fond_entier
...
#fond_entier(".streamlit/fondStreamlit.png")
            ...
            if df_in_france.empty:
                ...
                if not df_filtered.empty:
                    ...
                    for _, row in df_filtered.iterrows():
                        st.write(f"- **{row['name']}**")
                        st.image(row["image_url"] if row["image_url"] else ".streamlit/petit_chefv3.png", width=150)
