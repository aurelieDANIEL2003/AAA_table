...
if actor_nom.lower() in actor.lower()
    ] if actor_nom else []elif selection == "Recommandation par acteur":
    ...
    filtered_actors = [
        actor for actor in list_actor_unique 
...
# Page KPI
    ...
    #         st.error("Le fichier 'df' est introuvable.")
